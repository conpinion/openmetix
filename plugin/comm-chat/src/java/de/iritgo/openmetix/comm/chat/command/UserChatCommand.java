	...
	public void perform ()
	{
		...
		if (message.startsWith ("/"))
		{
			ConsoleManager consoleManager =
				(ConsoleManager) Engine.instance ().getManagerRegistry ().getManager ("console");
		...
		{
			ChatMessageServerAction chatMessageServerAction =
				new ChatMessageServerAction(message, channelId, userName);
