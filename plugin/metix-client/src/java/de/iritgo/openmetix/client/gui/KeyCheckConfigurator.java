 ...
 *
 * @version $Id: KeyCheckConfigurator.java,v 1.1 2005/04/24 18:10:42 grappendorf Exp $
 */
public class KeyCheckConfigurator
	...
	implements InstrumentConfigurator
{
	 ...
	 */
	public KeyCheckConfigurator ()
	{
		super("KeyCheckConfigurator");
	}
	...
	{
		return new KeyCheckConfigurator();
	}
	...
	public void initGUI ()
	{
		...
		{
			Log.logError ("client", "KeyCheckConfigurator.initGUI", x.toString ());
		}
