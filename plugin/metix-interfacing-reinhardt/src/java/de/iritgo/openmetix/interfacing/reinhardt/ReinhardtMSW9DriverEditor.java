 ...
 *
 * @version $Id: ReinhardtMSW9DriverEditor.java,v 1.1 2005/04/24 18:10:46 grappendorf Exp $
 */
public class ReinhardtMSW9DriverEditor
	extends GagingSystemDriverEditor
{
	 ...
	 */
	public ReinhardtMSW9DriverEditor ()
	{
	}
	...
	protected JPanel createEditorPanel ()
	{
		try
		{
			...
			JPanel panel =
				(JPanel) swingEngine.render (
					getClass ().getResource ("/swixml/ReinhardtMSW9DriverDialog.xml"));
		...
		{
			Log.logError ("client", "ReinhardtMSW9DriverDialog", x.toString ());
