 ...
 */
public class GagingSystemDriverThread
	extends Thread
{
	...
	{
		GagingSystemDriverDescriptor descriptor =
			GagingSystemDriverDescriptor.get (system.getDriverId ());

		InterfacingManager interfaceManager =
			(InterfacingManager) Engine.getManager ("InterfacingManager");
		...
		{
			Log.logError (
				"server", "GagingSystemDriverThread",
				"Unable to start driver thread for driver '" + descriptor.getId () + "' (" + x +
				")");
		}
