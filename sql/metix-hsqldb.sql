...
create cached table IritgoProperties
(
	name varchar (64) not null primary key,
	value varchar (80)
);

create cached table IritgoObjectList
(
	type varchar (64),
	id bigint,
...
create cached table IritgoUser
(
...
create cached table IritgoNamedObjects
(
	userId bigint,
	name varchar (80),
	id bigint
...
create cached table MetixUserRegistry
(
	id bigint not null primary key
);

create cached table MetixUser
(
	id bigint not null primary key,
	name varchar (80),
	password varchar (80),
...
(
	id bigint not null primary key,
	desktopList longvarchar,
	activeDesktopId varchar (80)
);

create cached table Preferences
(
	id bigint not null primary key,
	language varchar (16),
...
create cached table ActiveDisplay
(
	id bigint not null primary key,
...
create index index_1 on Measurement (at, stationId, sensorId);

create cached table GagingStationRegistry
(
	id bigint not null primary key
);

create cached table GagingStation
(
	id bigint not null primary key,
	name varchar (80),
	location varchar (80),
...
create cached table GagingSensor
(
	id bigint not null primary key,
	name varchar (80),
...
create cached table InterfaceRegistry
(
	id bigint not null primary key
);
...
create cached table SimpleInstrument
(
	id bigint not null primary key,
	fresh integer,
	title varchar (80),
...
create cached table SimpleInstrumentSensor
(
	id bigint not null primary key,
	sensorId bigint,
	stationId bigint,
...
create cached table BarInstrument
(
	id bigint not null primary key,
	fresh integer,
	title varchar (80),
...
create cached table BarInstrumentSensor
(
	id bigint not null primary key,
	sensorId bigint,
	stationId bigint,
...
create cached table LineChartSensor
(
	id bigint not null primary key,
	sensorId bigint,
	stationId bigint,
...
create cached table ListInstrument
(
	id bigint not null primary key,
	fresh integer,
	title varchar (80),
...
create cached table ListInstrumentSensor
(
	id bigint not null primary key,
	sensorId bigint,
	stationId bigint,
...
create cached table RoundInstrument
(
	id bigint not null primary key,
	fresh integer,
	title varchar (80),
...
create cached table RoundInstrumentSensor
(
	id bigint not null primary key,
	sensorId bigint,
	stationId bigint,
...
create cached table WebInstrument
(
	id bigint not null primary key,
	fresh integer,
	title varchar (80),
...
create cached table WebInstrumentSensor
(
	id bigint not null primary key,
	sensorId bigint,
	stationId bigint,
...
create cached table WindRoseInstrument
(
	id bigint not null primary key,
	fresh integer,
	title varchar (80),
...
create cached table WindRoseInstrumentSensor
(
	id bigint not null primary key,
	sensorId bigint,
	stationId bigint,
...
insert into IritgoUser (id, name, password, email) values
	(10002, 'metix', 'metix', 'metix@metix.de');
insert into IritgoUser (id, name, password, email) values
	(10004, 'alice', 'alice', 'alcie@metix.de');
insert into IritgoUser (id, name, password, email) values
	(10006, 'bob', 'bob', 'bob@metix.de');

insert into MetixUserRegistry (id) values (11000);

insert into MetixUser (id, name, password, email, role) values
	(10100, 'admin', 'admin', 'admin@metix.de', 2);
insert into MetixUser (id, name, password, email, role) values
	(10102, 'metix', 'metix', 'metix@metix.de', 0);
insert into MetixUser (id, name, password, email, role) values
	(10104, 'alice', 'alice', 'alice@metix.de', 0);
insert into MetixUser (id, name, password, email, role) values
	(10106, 'bob', 'bob', 'bob@metix.de', 0);
...
insert into GagingStationRegistry (id) values (11002);
...
insert into GagingStation (id, name, location, longitude, latitude) values
	(12010, 'Lambrecht', 'Lambrecht', 'Lokal', 'Lokal');
...
insert into InterfaceRegistry (id) values (11004);
