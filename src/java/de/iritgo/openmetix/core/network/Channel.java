	...
	extends Threadable
{
	 ...
	 */
	public Channel (Socket socket, NetworkService networkService)
		throws IOException
	{
	 ...
	 */
	public Channel (Socket socket, NetworkService networkService, double channelNumber)
		throws IOException
	{
	 ...
	 */
	private void init (Socket socket, NetworkService networkService, double channelNumber)
		throws IOException
	{
		this.socket = socket;
	...
	public void run ()
	{
		...
		try
		{
			...
			{
				Log.logWarn (
					"network", "Channel.run", "A network error occurred. Closing connection");
			...
			{
				Log.logError (
					"network", "Channel.run", "Receiving NULL-Object" + channelNumber + ").");
			...
			Log.logDebug (
				"network", "Channel.run", "Receiving Object (Channel:" + channelNumber + ").");
	...
	public void send (Object object)
	{
		try
		{
			Log.logDebug (
				...
				"Sending Object (Channel:" + channelNumber + "):" + object);
	 ...
	 */
	public void setStreamOrganizer (StreamOrganizer streamOrganizer)
		throws IOException
	{
