	...
	extends Command
{
	...
	{
		IDisplay display =
			Client.instance ().getClientGUI ().getDesktopManager ().getDisplay ("main.connect");
		...
		RegisterNewUserServerAction registerNewUserServerAction =
			new RegisterNewUserServerAction(nickname, email);
