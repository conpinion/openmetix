	...
	extends NetworkSystemAdapter
{
	...
	public void connectionTerminated (NetworkService networkBase, Channel connectedChannel)
	{
		...
		{
			Log.logError (
				"network", "NetworkSystemListenerImpl.work",
				"Unable to close connection: " + connectedChannel.getConnectionState ());
		}
		...
		Log.log (
			"network", "NetworkSystemListenerImpl.work",
			"Lost connection to server: " + connectedChannel.getConnectionState (), Log.INFO);
